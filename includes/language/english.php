...
$l['thepointbreakpack'] = 'THE POINT BREAK HEISTS PACK';
$l['dlc'] = 'DLC';
//Stash
$l['skinrequire'] = 'This Skin requires the';
$l['specials'] = 'Specials';
...
$l['skins'] = 'Skins';
$l['guntype'] = 'Guntype';
$l['includedmods'] = 'Included Modifications:';
$l['marketview'] = 'View on Market';
$l['akimbos'] = 'Akimbos';
//Safes
$l['safe'] = 'Safe';
$l['safes'] = 'Safes';
...
$l['bodhis'] = 'Bodhi';
$l['bodhis-info'] = 'Added Update #92 (10th December 2015)';
$l['xmass'] = 'Christmas';
$l['xmass-info'] = 'Added Update #93 (17th December 2015)<br/><br/>Added as part of the Christmas 2015 Event';
...
$l['akm_waves'] = 'Le Grand Bleu';
$l['akmsu_ginger'] = 'Wintry Wonder';
$l['asval_waves'] = 'Wave Snake';
$l['aug_waves'] = 'Turtle Roll';
$l['baka_waves'] = 'Chikara';
...
$l['g22c_ginger'] = 'Gluckseliger Uberfall';
...
$l['new_mp5_ginger'] = 'Ho-Ho-Ho';
$l['mosin_waves'] = 'Coo Coo Ca Choo';
...
$l['s552_waves'] = 'Hang Loose';
$l['scar_waves'] = 'Kapu';
$l['striker_waves'] = 'Riptide';
$l['usp_waves'] = 'Lip Jibber';
$l['wa2000_ginger'] = 'Santa\'s Helper';
$l['x_1911_ginger'] = 'Santa\'s Slayers';
$l['x_b92fs_ginger'] = 'Jingling Bullets';
$l['x_g22c_waves'] = 'Tribal Feud';
////Weapons
////Primary
//Assault Rifles
...
//Deck Ex-President
$l['perk-president'] = 'Ex-President';
$l['perk-president-desc'] = 'The Ex-Presidents are one of the most daring heisting crews out there. Great risk takers and brothers in arms. Their lack of fear of their own mortality brough them together and made them as successful as they are.<br/><br/>An Ex-President follows no rules and only adheres to the Ozaki 8, a set of trials to honor nature.';
$l['perk-president-1'] = 'Point Break';
$l['perk-president-1-desc'] = 'While your armor is up, you will store <div class="bluein">4</div> health for every <div class="bluein">1</div> enemy you or your crew kills.<br/><br/>When your armor has been completely depleted and then starts to regenerate, you will gain health equal to the stored health amount.<br/><br/>Maximum amount of stored health depends on your equipped armor.';
$l['perk-president-2'] = 'The Emerging Force';
$l['perk-president-2-desc'] = 'Increases the amount of health stored from kills by <div class="bluein">4</div>.<br/><br/>You gain <div class="bluein">10%</div> more health.<br/><br/>Your chance to dodge is increased by <div class="bluein">10%</div> when you have one of the ballistic vests equipped.';
$l['perk-president-3'] = 'Life of Ice';
$l['perk-president-3-desc'] = 'Increases the maximum health that can be stored by <div class="bluein">50%</div>.<br/><br/>You gain <div class="bluein">10%</div> more health.<br/><br/>Your chance to dodge is increased by <div class="bluein">5%</div>.';
$l['perk-president-4'] = 'Awakening Earth';
$l['perk-president-4-desc'] = 'Increases the amount of health stored from kills by <div class="bluein">4</div>.<br/><br/>You gain <div class="bluein">20%</div> more health.<br/><br/>Your chance to dodge is increased by <div class="bluein">10%</div> when you have one of the ballistic vests equipped.';
$l['perk-president-5'] = 'The Perfect Line';
$l['perk-president-5-desc'] = 'Killing an enemy speeds up your armor recovery time depending on how much armor you have. The more armor the less recovery speed gained per kill.<br/><br/>Armor recovery speed is reset whenever your armor recovers. <br/><br/>Deck Completion Bonus: Your chance of getting a higher quality item during a PAYDAY is increased by <div class="bluein">10%</div>.';
//Characters
$l['chars'] = 'Characters';
$l['houston'] = 'Houston';
$l['wick'] = 'John Wick';
...
//Skin Descriptions
$l['ak74_rodina-desc'] = 'A special-issue AK that - in war and crime - has demonstrated an unquenchable thirst for blood.';
$l['deagle_bling-desc'] = 'A hand-crafted Deagle built as testament to the finest gaming-trained crackshot in the world.';
$l['flamethrower_mk2_fire-desc'] = 'The Dragon Lord became famous during the so-called Tang Rebellion in 1976, when General Tang, an opium baron, summoned his rivals to a warehouse in Taipei, and proceeded to incinerate them (and much of Taipei).';
$l['m134_bulletstorm-desc'] = 'The steel in The Gimp has been re-cycled from weapons used in battle in Desert Storm, the Falklands, Operation Market Garden, the Somme and the Boer war.';
$l['p90_dallas_sallad-desc'] = 'The Jester Warrant was never too concerned with not leaving a trace, considering her weapon had a head of a meat hammer mounted in the front.<br/>Her identity was kept secret until her untimely end mostly because there was too much trouble just identifying her victims.';
$l['r870_waves-desc'] = 'Legendary heister Afano "Rocky" Jones, honored the traditions of his Samoan ancestors and satisfied his lust for thrills by etching his shotgun with tattoos that symbolize one of his greatest achievements - the completion of the Ozaki 8.';
$l['rpg7_boom-desc'] = 'Manuel Lopez was a successful druglord, who ran his operation out of Barranquillo docks.<br/>He loved the ocean, and especially loved killing it.<br/>Lopez would hunt sharks from his helicopter with this - the Green Grin.';
$l['x_1911_ginger-desc'] = 'He knows where you are sleeping, he knows when you\'re asleep.<br/>He penetrates the perimeter through the chimney, like a fucking creep.<br/>Be ready for his wrath, your presents undeserved.';
//Skin Mods
$l['ak5_waves-mods'] = '<ul><li>Bertil Stock</li><li>CAR Quadstacked Mag</li><li>CQB Barrel</li><li>Karbin Ceres Handguard</li><li>See More Sight</li><li>Tactical Compensator</li></ul>';
$l['ak74_golddigger-mods'] = '<ul><li>AK Plastic Grip</li><li>AK Quadstacked Mag</li><li>Classic Stock</li><li>Keymod Rail</li><li>Modern Barrel</li><li>Scope Mount</li><li>See More Sight</li><li>Tactical Compensator</li></ul>';
$l['ak74_luxury-mods'] = '<ul><li>AK Plastic Grip</li><li>AK Quadstacked Mag</li><li>Classic Stock</li><li>Keymod Rail</li><li>Modern Barrel</li><li>Scope Mount</li><li>See More Sight</li><li>Tactical Compensator</li></ul>';
$l['ak74_rodina-mods'] = '<ul><li>Low Drag Magazine</li><li>Scope Mount</li><li>See More Sight</li></ul>';
$l['ak74_bloodsplat-mods'] = '<ul><li>AK Plastic Grip</li><li>AK Quadstacked Mag</li><li>Classic Stock</li><li>Keymod Rail</li><li>Modern Barrel</li><li>Scope Mount</li><li>See More Sight</li><li>Tactical Compensator</li></ul>';
$l['akmsu_ginger-mods'] = '<ul><li>AK Quadstacked Mag</li><li>Classic Stock</li><li>Moscow Special Rail</li><li>Scope Mount</li><li>See More Sight</li><li>Tactical Compensator</li></ul>';
$l['b92fs_luxury-mods'] = '<ul><li>Ergo Grip</li><li>Monolith Suppressor</li><li>The Elite Slide</li></ul>';
$l['b92fs_wooh-mods'] = '<ul><li>Engraved Bernetti Grips</li><li>Extended Magazine</li><li>Pistol Red Dot Sight</li><li>The Elite Slide</li><li>The Professional Compensator</li></ul>';
$l['deagle_bling-mods'] = '<ul><li>Ergo Grip</li><li>Pistol Red Dot Sight</li></ul>';
$l['deagle_skullimov-mods'] = '<ul><li>Deagle Scope Mount</li><li>Ergo Grip</li><li>Extended Magazine</li><li>Marksman Sight</li><li>OVERKILL Compensator</li></ul>';
$l['famas_golddigger-mods'] = '<ul><li>G2 Grip</li><li>Sniper Barrel</li><li>Speculator Sight</li><li>Tactical Compensator</li></ul>';
$l['famas_hypno-mods'] = '<ul><li>G2 Grip</li><li>Sniper Barrel</li><li>Tactical Compensator</li></ul>';
$l['famas_bloodsplat-mods'] = '<ul><li>Short Barrel</li></ul>';
$l['flamethrower_mk2_bloodsplat-mods'] = '<ul><li>Rare</li></ul>';
$l['g22c_ginger-mods'] = '<ul><li>Ergo Grip</li><li>Extended Magazine</li><li>IPSC Compensator</li><li>Micro Laser</li><li>Pistol Red Dot Sight</li></ul>';
$l['g36_bloodbath-mods'] = '<ul><li>LED Combo</li><li>Polizei Special Foregrip</li><li>Sniper Stock</li><li>Tactical Compensator</li></ul>';
$l['g36_bloodsplat-mods'] = '<ul><li>LED Combo</li><li>Polizei Special Foregrip</li><li>Sniper Stock</li><li>Tactical Compensator</li></ul>';
$l['g36_dallas-mods'] = '<ul><li>LED Combo</li><li>Polizei Special Foregrip</li><li>Sniper Stock</li><li>Tactical Compensator</li></ul>';
$l['huntsman_hypno-mods'] = '<ul><li>AP Slug</li></ul>';
$l['huntsman_bloodsplat-mods'] = '<ul><li>Gangsta Special Stock</li><li>Road Warrior Barrel</li></ul>';
$l['judge_wooh-mods'] = '<ul><li>HE Round</li><li>King\'s Crown Compensator</li></ul>';
$l['judge_dallas-mods'] = '<ul><li>HE Round</li><li>King\'s Crown Compensator</li</ul>';
$l['m134_bloodsplat-mods'] = '<ul><li>Aerial Assault Barrel</li></ul>';
$l['m134_bulletstorm-mods'] = '<ul><li>LED Combo</li></ul>';
$l['m95_luxury-mods'] = '<ul><li>Rubber Grip</li><li>Tank Buster Barrel</li><li>Theia Magnified Scope</li></ul>';
$l['m95_bombmatta-mods'] = '<ul><li>Pro Grip</li><li>Suppressed Barrel</li><li>Theia Magnified Scope</li></ul>';
$l['m95_dallas-mods'] = '<ul><li>Rubber Grip</li><li>Tank Buster Barrel</li><li>Theia Magnified Scope</li></ul>';
$l['mg42_bloodbath-mods'] = '<ul><li>Competitor\'s Compensator</li><li>LED Combo</li><li>Light Barrel</li></ul>';
$l['mg42_bloodsplat-mods'] = '<ul><li>Light Barrel</li></ul>';
$l['new_m14_luxury-mods'] = '<ul><li>Acough Optic Scope</li><li>Jaeger Body</li><li>Scope Mount</li><li>Tactical Compensator</li></ul>';
$l['new_m14_bloodsplat-mods'] = '<ul><li>Acough Optic Scope</li><li>Jaeger Body</li><li>Scope Mount</li><li>The Bigger the Better Suppressor</li></ul>';
$l['mosin_waves-mods'] = '<ul><li>Discrete Stock</li><li>Short Barrel</li><li>Theia Magnified Scope</li></ul>';
$l['new_m4_payday-mods'] = '<ul><li>2 Piece Stock</li><li>Acough Optic Scope</li><li>Competitor\'s Compensator</li><li>E.M.O. Foregrip</li><li>Expert Mag</li><li>LW Upper Receiver</li><li>Long Barrel</li><li>Rubber Grip</li></ul>';
$l['new_m4_skullimov-mods'] = '<ul><li>2 Piece Stock</li><li>Acough Optic Scope</li><li>Competitor\'s Compensator</li><li>E.M.O. Foregrip</li><li>Expert Mag</li><li>LW Upper Receiver</li><li>Rubber Grip</li><li>Short Barrel</li></ul>';
$l['new_raging_bull_bloodsplat-mods'] = '<ul><li>Ergo Wooden Grip</li><li>Overcompensating Barrel</li><li>Slimline Body</li></ul>';
$l['p90_luxury-mods'] = '<ul><li>Holographic Sight</li><li>Mall Ninja Barrel</li></ul>';
$l['p90_skullimov-mods'] = '<ul><li>Competitor\'s Compensator</li><li>Long Barrel</li><li>See More Sight</li></ul>';
$l['p90_dallas_sallad-mods'] = '<ul><li>LED Combo</li><li>See More Sight</li></ul>';
$l['plainsrider_linked-mods'] = '<ul><li>Explosive Arrows</li></ul>';
$l['ppk_luxury-mods'] = '<ul><li>Laser Grip</li><li>Long Slide</li><li>Pistol Red Dot Sight</li></ul>';
$l['ppk_bloodsplat-mods'] = '<ul><li>Jungle Ninja Suppressor</li><li>Laser Grip</li><li>Long Slide</li></ul>';
$l['r93_bloodsplat-mods'] = '<ul><li>Theia Magnified Scope</li><li>Wooden Body</li></ul>';
$l['r93_wooh-mods'] = '<ul><li>Theia Magnified Scope</li></ul>';
$l['rpg7_boom-mods'] = '<ul><li>Solar Sight</li></ul>';
$l['serbu_golddigger-mods'] = '<ul><li>Extended Magazine</li><li>LED Combo</li><li>Police Shorty Stock</li><li>Rubber Grip</li><li>See More Sight</li><li>Shark Teeth Nozzle</li><li>Shell Rack</li></ul>';
$l['serbu_stunner-mods'] = '<ul><li>Ergo Grip</li><li>Extended Magazine</li><li>HE Round</li><li>Police Shorty Stock</li><li>Shark Teeth Nozzle</li></ul>';
$l['serbu_dallas-mods'] = '<ul><li>Ergo Grip</li><li>Extended Magazine</li><li>HE Round</li><li>Police Shorty Stock</li><li>Shark Teeth Nozzle</li></ul>';
$l['striker_waves-mods'] = '<ul><li>King\'s Crown Compensator</li><li>See More Sight</li></ul>';
$l['wa2000_ginger-mods'] = '<ul><li>Angled Sight</li><li>Langer Barrel</li><li>Theia Magnified Scope</li><li>Walnuss Grip</li></ul>';
$l['x_1911_ginger-mods'] = '<ul><li>Long Vented Slide</li></ul>';
$l['x_g22c_waves-mods'] = '<ul><li>Ergo Grip</li><li>Engraved Bernetti Grips</li><li>Extended Magazine</li><li>IPSC Compensator</li><li>Micro Laser</li></ul>';